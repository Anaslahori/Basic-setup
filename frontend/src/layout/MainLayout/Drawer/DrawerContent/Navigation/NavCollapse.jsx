...
// project import
import { IconChevronRight, IconChevronUp, IconChevronDown, IconSquare } from '@tabler/icons-react';
...
const NavCollapse = ({ menu, level, parentId, setSelectedItems, selectedItems, setSelectedLevel, selectedLevel }) => {
  ...
  const borderIcon = level === 1 ? <IconSquare style={{ fontSize: '1rem' }} /> : false;
      ...
      {menuOrientation === LAYOUT_CONST.VERTICAL_LAYOUT || downLG ? (
        <>
          ...
          >
            ...
            {(drawerOpen || (!drawerOpen && level !== 1)) &&
              (openMini || open ? (
                <IconChevronUp style={{ fontSize: '0.625rem', marginLeft: 1, color: theme.palette.primary.main }} />
              ) : (
                <IconChevronDown style={{ fontSize: '0.625rem', marginLeft: 1 }} />
              ))}
        ...
        <>
          ...
          >
            <Box onClick={handlerIconLink} sx={FlexBox}>
              ...
              />
              {openMini ? <IconChevronRight /> : <IconChevronDown />}
            </Box>
