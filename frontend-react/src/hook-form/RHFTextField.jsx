  ...
  const checkValueConditions = useCallback(
    (value) => {
      ...
      if (maxLength && maxLength < value.length) {
        errorMessage2 = `Maximum length is ${maxLength} characters.`;
      } else if (minLength && minLength > value.length) {
        errorMessage2 = `Minimum length is ${minLength} characters.`;
      } else if (type === 'number' && maxValue && parseFloat(maxValue) < parseFloat(value)) {
        errorMessage2 = `Maximum value should be ${maxValue}`;
      } else if (type === 'number' && minValue && parseFloat(minValue) > parseFloat(value)) {
